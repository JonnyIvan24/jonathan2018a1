...
<?php
    ...
    $sql = 'SELECT E.numero, E.nombre, E.salario, E.categoria, E.sexo, D.descripcion FROM 
empleados E INNER JOIN departamentos D ON E.departamento = D.departamento';
 ...
 /////echo (json_encode($rows)); //////////sirve para generar objetos json apartir de un arreglo de arreglos de una consulta
